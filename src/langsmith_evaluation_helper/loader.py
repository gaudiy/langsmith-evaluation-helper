...
def extract_metadata(dataset_examples, metadata_keys: list[str]) -> dict[str, Any] | None:
    if len(metadata_keys) == 0 or not dataset_examples or dataset_examples[0].metadata is None:
        return None
